...
public class ProductServiceImpl implements ProductService {
    ...
    public List<Product> findAll(int page, String name) {
        if (page < 1) throw new ResponseStatusException(HttpStatus.OK, "Page phải lớn hơn 0!!!");
    ...
    public Product findOne(long id) {
        ...
        try {
            ...
            product = productDAO.findOne(sql, Product.class);
        } catch (EmptyResultDataAccessException e) {
            throw new ResponseStatusException(HttpStatus.OK, "don't have this id");
        }
        return product;
    }
